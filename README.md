...
## Configurando Redux com React
  ...
  * A função shoppingListReducer é o nosso <code>reducer</code>, que recebe como parâmetro default, ou seja, se não enviarmos um novo estado o <code>reducer</code> irá receber o que 
  existe dentro do array <code>INITAL_STATE</code>, o estado inicial que acabamos de definir e uma <b><i>action</i></b>.

  * A <b><i>action</i></b>., por convenção mesmo, é um objeto que deverá possuir uma chave (key) <code>type</code>. É exatamente com essa chave que o <code>reducer</code> irá manipular o estado,
